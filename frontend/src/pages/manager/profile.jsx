...
export default function ManagerProfilePage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <SiteHeader title="Manager Profile" />

      <Card className="w-full max-w-xl mx-auto shadow-md border border-border">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold">Manager Details</CardTitle>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">{user.department || "Management"}</span>
            </div>
